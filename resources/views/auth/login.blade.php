...
<head>
    ...
    <meta content="Sistema de Mesa de Ayuda - HelpDesk " name="description">
            ...
            <div class="mt-12 flex flex-col items-center">
                ...
                <div class="w-full flex-1 mt-8">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mx-auto max-w-xs">
                        ...
                        <input
                            class="w-full px-8 py-4 rounded-lg bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-indigo-400 focus:bg-white"
                            type="email" name="email" placeholder="Correo electrónico" required autofocus />

                        <input
                            class="mt-5 w-full px-8 py-4 rounded-lg bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-indigo-400 focus:bg-white"
                        ...
                        <p class="mt-6 text-xs text-gray-600 text-center">
                            <a href="{{ route('password.request') }}" class="hover:underline">¿Olvidaste tu
                                contraseña?</a>
                        </p>

                        {{-- <p class="mt-2 text-xs text-gray-600 text-center">
                            ¿No tienes una cuenta?
                            <a href="{{ route('register') }}" class="text-indigo-600 hover:underline">Registrarse</a>
                        </p> --}}
                    </form>
